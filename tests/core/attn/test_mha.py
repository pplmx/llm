...
@pytest.mark.parametrize("mha_props", [{"include_norm_residual": True}, {"include_norm_residual": False}], indirect=True)
...
@pytest.mark.parametrize("mha_props", [{"is_causal": True, "include_norm_residual": True},
                                     {"is_causal": True, "include_norm_residual": False}], indirect=True)
...
def test_mha_internal_norm_first_when_norm_residual_active(norm_first_val):
    ...
    mha_opposite_norm, _ = create_mha_for_test(
