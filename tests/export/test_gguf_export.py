...
class TestExportPolicy:
    ...
    def test_reader_only_quantize_enum_raises_cleanly(self, small_model, tmp_path):
        ...
        HIGH regression)."""
        # Q4_1 / Q2_K are still reader-only (Q6_K/Q4_K/Q5_K are exportable since
        # their write-path milestones).
        for reader_only in (GGMLQuantizationType.Q4_1, GGMLQuantizationType.Q2_K):
