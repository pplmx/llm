...
if __name__ == "__main__":
    ...
    # MoE 的参数量主要由 experts 贡献, 外加一个小的 gate 网络。
    # expert 部分的参数量约等于 FFN 的 num_experts 倍。
