...
1. RoFormer (RoPE)
2. ALiBi Position Embedding

**高效架构**

1. GQA: Training Generalized Multi-Query Transformer
2. DeepSeek-V2 (MLA)
...
2. vLLM: Easy, Fast, and Cheap LLM Serving
3. DeepSpeed系列论文
...
1. 实现完整的MoE模型
2. 长上下文优化(支持32K+ tokens)
3. 构建高效推理引擎(集成Flash Attention, KV Cache优化等)
